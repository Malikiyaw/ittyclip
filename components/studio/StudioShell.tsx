    ...
    <div className="studio flex h-[100dvh] min-h-0 w-full min-w-0 flex-col overflow-hidden">
      ...
      {media ? (
        <div className="relative flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden md:flex-row">
          ...
          <div className="pointer-events-none absolute right-3 bottom-[4.5rem] z-40 hidden w-[320px] md:block">
            <div className="pointer-events-auto max-h-[70dvh] space-y-2 overflow-y-auto">
              <AIAssistant />
              <AICaptionTools />
              <AIContentTools />
            </div>
